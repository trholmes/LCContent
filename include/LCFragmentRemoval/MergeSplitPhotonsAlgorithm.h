...
private:
  ...
  float m_acceptSubsidiaryPeakEnergyRatio; ///< Max value of subsidiary peak/small fragment energy ratio to accept
                                           ///< cluster merge
  unsigned int
      m_earlyTransProfileMaxLayer; ///< Maximum layer to consider in calculation of early shower transverse profiles
};
