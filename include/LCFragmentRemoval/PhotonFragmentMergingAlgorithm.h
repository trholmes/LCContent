...
private:
  ...
  pandora::StatusCode DeleteClusters(const pandora::ClusterVector& photonClusterVec,
   ...
   *          the 2D shower profile (a triangular cut on ratio of energy of first peak to main cluster and ratio of
   * energy of second peak to candidate cluster) and is close to the main cluster
   *
   *  @param  parameters the cluster comparison parameters
   *
   *  @return boolean
  ...
  float m_centroidSeparationPhotonNeutralThresholdLow1; ///< Distance separation between two centroids of two clusters
                                                        ///< threshold for low energy neutral 1
  float m_hitSeparationPhotonNeutralThresholdHigh3; ///< Closest distance separation between two clusters at calo hits
                                                    ///< level threshold for high energy neutral 3
  float m_energyRatioCandidateToMainNeutralThresholdHigh3; ///< Ratio of energy of candidate culster to main cluster for
                                                           ///< high energy neutral 3
  float m_weightedLayerSeparationPhotonNeutralThresholdHigh3;  ///< Distance weighted over layer between candidate and
                                                               ///< main threshold for high energy neutral 3
  float m_energyOfCandidateClusterPhotonNeutralThresholdHigh3; ///< Energy of candidate cluster threshold for high
                                                               ///< energy neutral 3
  float m_hitSeparationPhotonNeutralThresholdHigh4; ///< Closest distance separation between two clusters at calo hits
                                                    ///< level threshold for high energy neutral 4
  float m_energyRatioCandidateToMainNeutralThresholdHigh4; ///< Ratio of energy of candidate culster to main cluster for
                                                           ///< high energy neutral 4
  float m_weightedLayerSeparationPhotonNeutralThresholdHigh4;  ///< Distance weighted over layer between candidate and
                                                               ///< main threshold for high energy neutral 4
  float m_energyOfCandidateClusterPhotonNeutralThresholdHigh4; ///< Energy of candidate cluster threshold for high
                                                               ///< energy neutral 4
  float m_centroidSeparationPhotonPhotonThresholdLow3; ///< Distance separation between two centroids of two clusters
                                                       ///< threshold for low energy photon 3
  float m_energyOfCandidateClusterPhotonPhotonThresholdLow4;  ///< Energy of candidate cluster threshold for low energy
                                                              ///< photon 4
  float m_cosineBarrelLimit;                                  ///< Cosine of the barrel limit
  unsigned int m_nCaloHitsCandidatePhotonPhotonThresholdLow5; ///< Number of calo hits for candidate threshold for low
                                                              ///< energy photon 5
  float m_weightedLayerSeparationPhotonPhotonThresholdLow5; ///< Distance weighted over layer between candidate and main
                                                            ///< threshold for low energy photon 5
  float m_hitSeparationPhotonPhotonThresholdLow6; ///< Closest distance separation between two clusters at calo hits
                                                  ///< level threshold for low energy photon 6
  float m_energyRatioCandidateToMainPhotonThresholdLow6; ///< Ratio of energy of candidate culster to main cluster for
                                                         ///< low energy photon 6
  float m_weightedLayerSeparationPhotonPhotonThresholdLow6; ///< Distance weighted over layer between candidate and main
                                                            ///< threshold for low energy photon 6
  float m_hitSeparationPhotonPhotonThresholdHigh2; ///< Closest distance separation between two clusters at calo hits
                                                   ///< level threshold for high energy photon 2
  float m_energyRatioCandidateToMainPhotonThresholdHigh2; ///< Ratio of energy of candidate culster to main cluster for
                                                          ///< high energy photon 2
  float m_weightedLayerSeparationPhotonPhotonThresholdHigh2; ///< Distance weighted over layer between candidate and
                                                             ///< main threshold for high energy photon 2
};
