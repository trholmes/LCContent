...
private:
  ...
  public:
     ...
     */
    TrackDistanceInfo(const pandora::CaloHit* const pCaloHit, const pandora::Cluster* const pCluster, float trackEnergy,
                      float trackDistance);
...
inline bool ForcedClusteringAlgorithm::SortByDistanceToTrack(const TrackDistanceInfo& lhs,
                                                             const TrackDistanceInfo& rhs) {
...
inline ForcedClusteringAlgorithm::TrackDistanceInfo::TrackDistanceInfo(const pandora::CaloHit* const pCaloHit,
                                                                       const pandora::Cluster* const pCluster,
                                                                       float trackEnergy, float trackDistance)
    : m_pCaloHit(pCaloHit), m_pCluster(pCluster), m_trackEnergy(trackEnergy), m_trackDistance(trackDistance) {}

//------------------------------------------------------------------------------------------------------------------------------------------

inline const pandora::CaloHit* ForcedClusteringAlgorithm::TrackDistanceInfo::GetCaloHit() const { return m_pCaloHit; }

//------------------------------------------------------------------------------------------------------------------------------------------

inline const pandora::Cluster* ForcedClusteringAlgorithm::TrackDistanceInfo::GetCluster() const { return m_pCluster; }

//------------------------------------------------------------------------------------------------------------------------------------------

inline float ForcedClusteringAlgorithm::TrackDistanceInfo::GetTrackEnergy() const { return m_trackEnergy; }

//------------------------------------------------------------------------------------------------------------------------------------------

inline float ForcedClusteringAlgorithm::TrackDistanceInfo::GetTrackDistance() const { return m_trackDistance; }
