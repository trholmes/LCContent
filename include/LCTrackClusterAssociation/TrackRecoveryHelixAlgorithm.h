...
private:
  ...
  float m_maxTrackClusterDeltaZ;      ///< Max z separation between track calorimeter projection and cluster to allow
                                      ///< association
  float m_maxAbsoluteTrackClusterChi; ///< Max absolute track-cluster consistency chi value to allow association
  unsigned int
      m_maxLayersCrossed; ///< Max number of layers crossed by track helix between calorimeter projection and cluster
  ...
  unsigned int
      m_helixComparisonMaxOccupiedLayers; ///< Max number of occupied cluster layers used in cluster-helix comparison
...
inline TrackRecoveryHelixAlgorithm::AssociationInfo::AssociationInfo(const pandora::Cluster* const pCluster,
                                                                     const float closestApproach)
    : m_pCluster(pCluster), m_closestApproach(closestApproach) {}

//------------------------------------------------------------------------------------------------------------------------------------------

inline const pandora::Cluster* TrackRecoveryHelixAlgorithm::AssociationInfo::GetCluster() const { return m_pCluster; }

//------------------------------------------------------------------------------------------------------------------------------------------

inline float TrackRecoveryHelixAlgorithm::AssociationInfo::GetClosestApproach() const { return m_closestApproach; }
