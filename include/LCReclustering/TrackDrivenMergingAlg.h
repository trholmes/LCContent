...
public:
   ...
   *  @param  clusterIndex the index of the cluster in the associated cluster vector (needed for tidying up in this
   * algorithm)
   */
...
inline ClusterConeFraction::ClusterConeFraction(float coneFraction, const pandora::Cluster* const pCluster,
                                                unsigned int clusterIndex)
    : m_coneFraction(coneFraction), m_pCluster(pCluster), m_clusterIndex(clusterIndex) {}
...
inline float ClusterConeFraction::GetConeFraction() const { return m_coneFraction; }

//------------------------------------------------------------------------------------------------------------------------------------------

inline const pandora::Cluster* ClusterConeFraction::GetCluster() const { return m_pCluster; }

//------------------------------------------------------------------------------------------------------------------------------------------

inline unsigned int ClusterConeFraction::GetClusterIndex() const { return m_clusterIndex; }
