...
private:
  ...
  float m_perpendicularDistanceCutFine;   ///< Fine granularity cut on perp. distance between fit direction and centroid
                                          ///< difference
  float m_perpendicularDistanceCutCoarse; ///< Coarse granularity cut on perp. distance between fit direction and
                                          ///< centroid difference
};
