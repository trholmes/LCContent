...
private:
  ...
  pandora::StatusCode PerformFragmentation(const pandora::Cluster* const pOriginalCluster,
  ...
  unsigned int
      m_nTransitionLayers; ///< Number of transition layers, treated more flexibly, between shower and mip-region
};
