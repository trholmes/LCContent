...
private:
  ...
  /**
   *  @brief  Get the smallest distance between a hit in a cluster and the projected initial direction of a second
   * cluster.
   *
   ...
   */
  float GetDistanceFromInitialProjection(const pandora::Cluster* const pClusterToProject,
                                         const pandora::Cluster* const pClusterToExamine) const;
  ...
  unsigned int
      m_minCaloHitsPerDaughterCluster; ///< The min number of calo hits for cluster to be used as a daughter cluster
  unsigned int
      m_minCaloHitsPerParentCluster; ///< The min number of calo hits for cluster to be used as a parent cluster
  ...
  unsigned int
      m_nProjectionExaminationLayers; ///< Number of layers to examine to calculate distance from initial projection
