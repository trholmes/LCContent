...
private:
   ...
   */
  pandora::StatusCode GetMuonEntryPoint(const pandora::Helix& helix, const bool isPositiveZ,
                                        pandora::CartesianVector& muonEntryPoint) const;
   ...
   */
  pandora::StatusCode GetPfoComponents(pandora::TrackList& pfoTrackList, pandora::CaloHitList& pfoCaloHitList,
                                       pandora::ClusterList& pfoClusterList) const;
  ...
  std::string
      m_outputMuonCaloHitListName; ///< The name of the output muon calo hit list, after removal of hits in muon pfos
...
inline bool MuonReconstructionAlgorithm::SortByDistanceToTrack(const TrackDistanceInfo& lhs,
