...
private:
  ...
  float m_profileDiscrepancyCutParameter1; ///< Parameter1 for calculation of discrepancy cut (for clusters passing
                                           ///< energy cut)
  float m_profileDiscrepancyCutParameter2; ///< Parameter2 for calculation of discrepancy cut (for clusters passing
                                           ///< energy cut)
  ...
  float m_minOverlapRadialDirectionCosine; ///< Minimum radial direction cosine for clusters in barrel-endcap overlap
                                           ///< region
