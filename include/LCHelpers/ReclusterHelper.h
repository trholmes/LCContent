...
public:
   ...
   *  @return the chi value for the suitability of the track/cluster associations
   */
  static float GetTrackClusterCompatibility(const pandora::Pandora& pandora, const float clusterEnergy,
                                            const float trackEnergy);

  /**
   *  @brief  Extract recluster results, indicating suitability of recluster candidates as a replacement for the
   * original clusters
   *
   *  @param  pandora the associated pandora instance
   ...
   */
  static pandora::StatusCode ExtractReclusterResults(const pandora::Pandora& pandora,
                                                     const pandora::ClusterList* const pReclusterCandidatesList,
...
inline float ReclusterResult::GetChi() const { return m_chi.Get(); }

//------------------------------------------------------------------------------------------------------------------------------------------

inline float ReclusterResult::GetChi2() const { return m_chi2.Get(); }

//------------------------------------------------------------------------------------------------------------------------------------------

inline float ReclusterResult::GetChiPerDof() const { return m_chiPerDof.Get(); }

//------------------------------------------------------------------------------------------------------------------------------------------

inline float ReclusterResult::GetChi2PerDof() const { return m_chi2PerDof.Get(); }

//------------------------------------------------------------------------------------------------------------------------------------------

inline float ReclusterResult::GetUnassociatedEnergy() const { return m_unassociatedEnergy.Get(); }

//------------------------------------------------------------------------------------------------------------------------------------------

inline float ReclusterResult::GetMinTrackAssociationEnergy() const { return m_minTrackAssociationEnergy.Get(); }

//------------------------------------------------------------------------------------------------------------------------------------------

inline unsigned int ReclusterResult::GetNExcessTrackAssociations() const { return m_nExcessTrackAssociations.Get(); }
