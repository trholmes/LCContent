...
private:
  ...
  /**
   *  @brief  Create particle flow objects starting from tracks in the main tracker. The pfos will account for
   * associated daughter/sibling tracks and associated calorimeter clusters.
   */
   ...
   */
  pandora::StatusCode PopulateTrackBasedPfo(const pandora::Track* const pTrack, PfoParameters& pfoParameters,
                                            const bool readSiblingInfo = true) const;
   ...
   *  @param  pfoParameters the pfo parameters to populate
   */
  pandora::StatusCode SetTrackBasedPfoParameters(const pandora::Track* const pTrack,
   ...
   *  @param  pfoParameters the pfo parameters to populate
   */
  pandora::StatusCode SetSiblingTrackBasedPfoParameters(const pandora::Track* const pTrack,
                                                        PfoParameters& pfoParameters) const;
   ...
   *  @param  pfoParameters the pfo parameters to populate
   */
  pandora::StatusCode SetDaughterTrackBasedPfoParameters(const pandora::Track* const pTrack,
                                                         PfoParameters& pfoParameters) const;
   ...
   *  @param  pfoParameters the pfo parameters to populate
   */
  pandora::StatusCode SetSimpleTrackBasedPfoParameters(const pandora::Track* const pTrack,
                                                       PfoParameters& pfoParameters) const;

  /**
   *  @brief  Create particle flow objects corresponding to neutral particles, These pfos consist only of clusters that
   * have no associated tracks.
   */
  ...
  float m_minClusterElectromagneticEnergy; ///< Min electromagnetic energy for neutral (photon) clusters to be added to
                                           ///< pfos
