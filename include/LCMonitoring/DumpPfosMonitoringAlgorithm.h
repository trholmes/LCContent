...
#define FORMATTED_OUTPUT_PFO_HEADER(N1, E2)                                                                            \
  std::cout << std::right << std::setw(widthInt) << N1 << std::right << std::setw(widthFloat) << E2

#define FORMATTED_OUTPUT_PFO_HEADER_TITLE()                                                                            \
  std::cout << std::right << std::setw(widthInt) << "Pfo" << std::right << std::setw(widthFloat) << "EPfo"

#define FORMATTED_PFO_PADDING(TITLE1, TITLE2)                                                                          \
  std::cout << std::right << std::setw(widthInt) << TITLE1 << std::right << std::setw(widthFloat) << TITLE2

#define FORMATTED_OUTPUT_CONFUSION(E1, E2, E3, E4, E5, E6, E7, E8, E9)                                                 \
  std::cout << std::right << std::setw(16) << " Generated as   " << std::right << std::setw(widthFloat) << "track"     \
            << std::right << std::setw(widthFloat) << "gamma" << std::right << std::setw(widthFloat) << "hadron"       \
            << std::endl                                                                                               \
            << std::right << std::setw(16) << "Reco as track : " << std::right << std::setw(widthFloat) << E1          \
            << std::right << std::setw(widthFloat) << E2 << std::right << std::setw(widthFloat) << E3 << std::endl     \
            << std::right << std::setw(16) << "Reco as gamma : " << std::right << std::setw(widthFloat) << E4          \
            << std::right << std::setw(widthFloat) << E5 << std::right << std::setw(widthFloat) << E6 << std::endl     \
            << std::right << std::setw(16) << "Reco as hadron: " << std::right << std::setw(widthFloat) << E7          \
            << std::right << std::setw(widthFloat) << E8 << std::right << std::setw(widthFloat) << E9 << std::endl

#define FORMATTED_OUTPUT_TRACK_TITLE()                                                                                 \
  std::cout << std::right << std::setw(widthInt) << "Track" << std::right << std::setw(widthFlag) << "(" << std::right \
            << std::setw(widthInt) << "mc" << std::left << std::setw(widthFlag) << ")" << std::right                   \
            << std::setw(widthFlag) << "C" << std::right << std::setw(widthFlag) << "R" << std::right                  \
            << std::setw(widthFloat) << "Mom" << std::right << std::setw(widthFlag) << "(" << std::right               \
            << std::setw(widthFloat) << "mc" << std::left << std::setw(widthFlag) << ")" << std::right                 \
            << std::setw(widthFloat) << "Eclust" << std::right << std::setw(widthFloat) << "tclust" << std::right      \
            << std::setw(widthFloat) << "chi" << std::right << std::setw(widthFlag) << "L" << std::right               \
            << std::setw(widthSmallFloat) << "fC" << std::right << std::setw(widthSmallFloat) << "fP" << std::right    \
            << std::setw(widthSmallFloat) << "fN" << std::endl

#define FORMATTED_OUTPUT_TRACK(N1, N2, FLAG1, FLAG2, E1, E2, E3, E4, E5, FLAG3, E6, E7, E8)                            \
  std::cout << std::right << std::setw(widthInt) << N1 << std::right << std::setw(widthFlag) << "(" << std::right      \
            << std::setw(widthInt) << N2 << std::left << std::setw(widthFlag) << ")" << std::right                     \
            << std::setw(widthFlag) << FLAG1 << std::right << std::setw(widthFlag) << FLAG2 << std::right              \
            << std::setw(widthFloat) << E1 << std::right << std::setw(widthFlag) << "(" << std::right                  \
            << std::setw(widthFloat) << E2 << std::left << std::setw(widthFlag) << ")" << std::right                   \
            << std::setw(widthFloat) << E3 << std::right << std::setw(widthFloat) << E4 << std::right                  \
            << std::setw(widthFloat) << E5 << std::right << std::setw(widthFlag) << FLAG3 << std::right                \
            << std::setw(widthSmallFloat) << E6 << std::right << std::setw(widthSmallFloat) << E7 << std::right        \
            << std::setw(widthSmallFloat) << E8

#define FORMATTED_OUTPUT_NEUTRAL(E1, E2, E3, E4, E5, N1, N2, E6, E7)                                                   \
  std::cout << std::right << std::setw(widthFloat) << E1 << std::right << std::setw(widthFloat) << E2 << std::right    \
            << std::setw(widthInt4) << "     " << std::right << std::setw(widthSmallFloat) << E3 << std::right         \
            << std::setw(widthSmallFloat) << E4 << std::right << std::setw(widthSmallFloat) << E5 << std::right        \
            << std::setw(widthInt4) << N1 << std::left << std::setw(widthFlag) << "-" << std::left                     \
            << std::setw(widthInt4) << N2 << std::right << std::setw(widthFloat) << E6 << std::right                   \
            << std::setw(widthFloat) << E7

#define FORMATTED_OUTPUT_NEUTRAL_TITLE()                                                                               \
  std::cout << std::right << std::setw(widthFloat) << "Eclust" << std::right << std::setw(widthFloat) << "tclust"      \
            << std::right << std::setw(widthInt4) << "     " << std::right << std::setw(widthSmallFloat) << "fC"       \
            << std::right << std::setw(widthSmallFloat) << "fP" << std::right << std::setw(widthSmallFloat) << "fN"    \
            << std::left << std::setw(widthInt4 + widthFlag + widthInt4) << " Layers " << std::right                   \
            << std::setw(widthFloat) << "sStart" << std::right << std::setw(widthFloat) << "sDisc" << std::endl

#define FORMATTED_OUTPUT_GOODENERGY(E1, E2, E3, E4)                                                                    \
  std::cout << std::right << std::setw(22) << "Unconfused energy : " << std::right << std::setw(widthBigFloat) << E1   \
            << std::right << std::setw(widthBigFloat) << E2 << std::right << std::setw(widthBigFloat) << E3            \
            << std::right << std::setw(4) << " : " << std::right << std::setw(widthBigFloat) << E4 << std::endl;

#define FORMATTED_OUTPUT_BADENERGY(E1, E2, E3, E4)                                                                     \
  std::cout << std::right << std::setw(22) << "Confused   energy : " << std::right << std::setw(widthBigFloat) << E1   \
            << std::right << std::setw(widthBigFloat) << E2 << std::right << std::setw(widthBigFloat) << E3            \
            << std::right << std::setw(4) << " : " << std::right << std::setw(widthBigFloat) << E4 << std::endl;
