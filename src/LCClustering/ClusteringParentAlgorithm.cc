...
ClusteringParentAlgorithm::ClusteringParentAlgorithm()
    : m_restoreOriginalCaloHitList(false), m_replaceCurrentClusterList(true) {}
...
StatusCode ClusteringParentAlgorithm::ReadSettings(const TiXmlHandle xmlHandle) {
  ...
  // Input parameters: name of input calo hit list and whether it should persist as the current list after algorithm has
  // finished
