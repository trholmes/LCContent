...
template <>
KDTreeCube fill_and_bound_3d_kd_tree<const pandora::Track>(
    const pandora::Algorithm* const /*caller*/, const MANAGED_CONTAINER<const pandora::Track*>& points,
...
KDTreeTesseract build_4d_kd_search_region(const pandora::CartesianVector& pos, const float x_span, const float y_span,
  ...
  return KDTreeTesseract(x_side.first, x_side.second, y_side.first, y_side.second, z_side.first, z_side.second,
