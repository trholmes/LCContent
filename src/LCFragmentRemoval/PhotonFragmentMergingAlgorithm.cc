...
PhotonFragmentMergingAlgorithm::PhotonFragmentMergingAlgorithm()
    : m_centroidSeparationPhotonNeutralThresholdLow1(40.f), m_hitSeparationPhotonNeutralThresholdHigh3(20.f),
      m_energyRatioCandidateToMainNeutralThresholdHigh3(0.1f),
      m_weightedLayerSeparationPhotonNeutralThresholdHigh3(40.f),
      m_energyOfCandidateClusterPhotonNeutralThresholdHigh3(10.f), m_hitSeparationPhotonNeutralThresholdHigh4(20.f),
      m_energyRatioCandidateToMainNeutralThresholdHigh4(0.2f),
      m_weightedLayerSeparationPhotonNeutralThresholdHigh4(20.f),
      m_energyOfCandidateClusterPhotonNeutralThresholdHigh4(10.f), m_centroidSeparationPhotonPhotonThresholdLow3(50.f),
      m_energyOfCandidateClusterPhotonPhotonThresholdLow4(0.6f), m_cosineBarrelLimit(0.7f),
      m_nCaloHitsCandidatePhotonPhotonThresholdLow5(20), m_weightedLayerSeparationPhotonPhotonThresholdLow5(50.f),
      m_hitSeparationPhotonPhotonThresholdLow6(20.f), m_energyRatioCandidateToMainPhotonThresholdLow6(0.01f),
      m_weightedLayerSeparationPhotonPhotonThresholdLow6(40.f), m_hitSeparationPhotonPhotonThresholdHigh2(20.f),
...
bool PhotonFragmentMergingAlgorithm::GetPhotonPhotonMergingFlag(const Parameters& parameters) const {
  if (parameters.m_energyOfCandidateCluster < m_lowEnergyOfCandidateClusterThreshold) {
    return (this->IsPhotonFragmentInShowerProfile(parameters) || this->IsAbsoluteLowEnergyPhotonFragment(parameters) ||
            this->IsSmallPhotonFragment1(parameters) || this->IsSmallForwardPhotonFragment(parameters) ||
            this->IsSmallPhotonFragment2(parameters) || this->IsRelativeLowEnergyPhotonFragment(parameters));
  } else {
...
bool PhotonFragmentMergingAlgorithm::GetPhotonNeutralMergingFlag(const Parameters& parameters) const {
  if (parameters.m_energyOfCandidateCluster < m_lowEnergyOfCandidateClusterThreshold) {
    return (this->IsCloseByNeutralFragment(parameters) || this->IsSmallNeutralFragment(parameters) ||
...
StatusCode PhotonFragmentMergingAlgorithm::DeleteClusters(const ClusterVector& /*photonClusterVec*/,
                                                          const ClusterVector& /*neutralClusterVec*/,
...
bool PhotonFragmentMergingAlgorithm::IsPhotonFragmentInShowerProfile(const Parameters& parameters) const {
  return (parameters.m_energyOfCandidateCluster > 0.f &&
          ...
          (parameters.m_energyOfMainPeak) / (parameters.m_energyOfCandidateCluster + parameters.m_energyOfMainCluster) >
              m_minRatioTotalShowerPeakEnergyToTotalEnergyThreshold &&
          ((parameters.m_energyOfCandidatePeak < std::numeric_limits<float>::min()) ||
           (parameters.m_energyOfCandidatePeak / parameters.m_energyOfCandidateCluster <
                m_smallCandidateFractionThresholdLow &&
...
bool PhotonFragmentMergingAlgorithm::IsRelativeLowEnergyPhotonFragment(const Parameters& parameters) const {
  return (parameters.m_energyOfMainCluster > 0.f &&
          ...
          parameters.m_energyOfCandidateCluster / parameters.m_energyOfMainCluster <
              m_energyRatioCandidateToMainPhotonThresholdLow6 &&
...
bool PhotonFragmentMergingAlgorithm::IsHighEnergyPhotonFragmentInShowerProfile(const Parameters& parameters) const {
  return (parameters.m_energyOfCandidateCluster > 0.f && parameters.m_energyOfMainCluster > 0.f &&
          parameters.m_energyOfMainPeak > 0.f && parameters.m_weightedLayerSeparation > m_minWeightedLayerSeparation &&
          (parameters.m_energyOfMainPeak) / (parameters.m_energyOfCandidateCluster + parameters.m_energyOfMainCluster) >
              m_minRatioTotalShowerPeakEnergyToTotalEnergyThreshold &&
...
bool PhotonFragmentMergingAlgorithm::IsHighEnergyRelativeLowEnergyPhotonFragment(const Parameters& parameters) const {
  return (parameters.m_energyOfCandidateCluster > 0.f && parameters.m_energyOfMainCluster > 0.f &&
          ...
          parameters.m_energyOfCandidateCluster / parameters.m_energyOfMainCluster <
              m_energyRatioCandidateToMainPhotonThresholdHigh2 &&
...
bool PhotonFragmentMergingAlgorithm::IsHighEnergyRelativeLowEnergyNeutralFragment2(const Parameters& parameters) const {
  return (parameters.m_energyOfCandidateCluster > 0.f && parameters.m_energyOfMainCluster > 0.f &&
          ...
          parameters.m_energyOfCandidateCluster / parameters.m_energyOfMainCluster <
              m_energyRatioCandidateToMainNeutralThresholdHigh3 &&
...
bool PhotonFragmentMergingAlgorithm::IsHighEnergyRelativeLowEnergyNeutralFragment3(const Parameters& parameters) const {
  return (parameters.m_energyOfCandidateCluster > 0.f && parameters.m_energyOfMainCluster > 0.f &&
          ...
          parameters.m_energyOfCandidateCluster / parameters.m_energyOfMainCluster <
              m_energyRatioCandidateToMainNeutralThresholdHigh4 &&
...
StatusCode PhotonFragmentMergingAlgorithm::ReadSettings(const TiXmlHandle xmlHandle) {
  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "CentroidSeparationPhotonNeutralThresholdLow1",
                                                       m_centroidSeparationPhotonNeutralThresholdLow1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle,
                                                       "ClosestDistanceSeparationPhotonNeutralThresholdHigh3",
                                                       m_hitSeparationPhotonNeutralThresholdHigh3));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "EnergyRatioCandidateToMainNeutralThresholdHigh3",
                                                       m_energyRatioCandidateToMainNeutralThresholdHigh3));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "WeightedLayerSeparationPhotonNeutralThresholdHigh3",
                                                       m_weightedLayerSeparationPhotonNeutralThresholdHigh3));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "EnergyOfCandidateClusterPhotonNeutralThresholdHigh3",
                                                       m_energyOfCandidateClusterPhotonNeutralThresholdHigh3));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle,
                                                       "ClosestDistanceSeparationPhotonNeutralThresholdHigh4",
                                                       m_hitSeparationPhotonNeutralThresholdHigh4));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "EnergyRatioCandidateToMainNeutralThresholdHigh4",
                                                       m_energyRatioCandidateToMainNeutralThresholdHigh4));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "WeightedLayerSeparationPhotonNeutralThresholdHigh4",
                                                       m_weightedLayerSeparationPhotonNeutralThresholdHigh4));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "EnergyOfCandidateClusterPhotonNeutralThresholdHigh4",
                                                       m_energyOfCandidateClusterPhotonNeutralThresholdHigh4));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "CentroidSeparationPhotonPhotonThresholdLow3",
                                                       m_centroidSeparationPhotonPhotonThresholdLow3));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "EnergyOfCandidateClusterPhotonPhotonThresholdLow4",
                                                       m_energyOfCandidateClusterPhotonPhotonThresholdLow4));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "CosineBarrelLimit", m_cosineBarrelLimit));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "NCaloHitsCandidatePhotonPhotonThresholdLow5",
                                                       m_nCaloHitsCandidatePhotonPhotonThresholdLow5));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "WeightedLayerSeparationPhotonPhotonThresholdLow5",
                                                       m_weightedLayerSeparationPhotonPhotonThresholdLow5));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ClosestDistanceSeparationPhotonPhotonThresholdLow6",
                                                       m_hitSeparationPhotonPhotonThresholdLow6));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "EnergyRatioCandidateToMainPhotonThresholdLow6",
                                                       m_energyRatioCandidateToMainPhotonThresholdLow6));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "WeightedLayerSeparationPhotonPhotonThresholdLow6",
                                                       m_weightedLayerSeparationPhotonPhotonThresholdLow6));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HitSeparationPhotonPhotonThresholdHigh2",
                                                       m_hitSeparationPhotonPhotonThresholdHigh2));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "EnergyRatioCandidateToMainPhotonThresholdHigh2",
                                                       m_energyRatioCandidateToMainPhotonThresholdHigh2));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "WeightedLayerSeparationPhotonPhotonThresholdHigh2",
                                                       m_weightedLayerSeparationPhotonPhotonThresholdHigh2));
