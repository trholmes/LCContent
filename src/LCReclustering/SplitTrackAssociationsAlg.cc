...
SplitTrackAssociationsAlg::SplitTrackAssociationsAlg()
    : m_minTrackAssociations(2), m_maxTrackAssociations(std::numeric_limits<unsigned int>::max()),
      m_chiToAttemptReclustering(-3.f), m_minChi2Improvement(1.f), m_minClusterEnergyForTrackAssociation(0.1f),
      m_chi2ForAutomaticClusterSelection(1.f), m_usingOrderedAlgorithms(false), m_bestChi2ForReclusterHalt(4.f),
      m_currentChi2ForReclusterHalt(16.f), m_shouldUseForcedClustering(false), m_minChiForForcedClustering(4.f),
